...
body[data-dsh-mari-interface] {
  ...
  --dsw-specific-sidebar-fill: rgba(248, 237, 242, 0.98);
}
...
body[data-dsh-mari-interface] :is([data-pane='sidebar'], [class*='sidebarCol']) {
  ...
  --dsw-alias-label-tertiary: #927586;
  --dsw-alias-label-caption: #aa909d;
  --dsw-alias-border-l1: rgba(138, 31, 85, 0.14);
  --dsw-alias-border-l2: rgba(138, 31, 85, 0.24);
  --dsw-alias-interactive-bg-hover: rgba(240, 75, 145, 0.085);
  --dsw-alias-interactive-bg-active: rgba(240, 75, 145, 0.17);
  position: relative;
  z-index: 6;
  color: #261722;
  border-right: 1px solid rgba(138, 31, 85, 0.26);
  background: #f8edf2;
  box-shadow: 12px 0 38px rgba(87, 27, 58, 0.1), inset -2px 0 rgba(240, 75, 145, 0.08);
}

body[data-dsh-mari-interface][data-ds-dark-theme] :is([data-pane='sidebar'], [class*='sidebarCol']) {
  --dsw-alias-label-primary: #fff4f9;
  ...
  color: #fff4f9;
  border-right-color: rgba(240, 75, 145, 0.45);
  background: #200b1b;
...
body[data-dsh-mari-interface] :is([data-pane='sidebar'], [class*='sidebarCol']) > div {
  ...
  overflow: hidden;
  background:
    linear-gradient(105deg, transparent 0 86%, rgba(138, 31, 85, 0.05) 86% 87%, transparent 87%),
    radial-gradient(circle at 50% 12%, rgba(240, 75, 145, 0.1), transparent 33%),
    repeating-linear-gradient(0deg, rgba(138, 31, 85, 0.015) 0 1px, transparent 1px 5px),
    linear-gradient(180deg, #fff5f8, #f0dde6 72%);
}

body[data-dsh-mari-interface][data-ds-dark-theme] :is([data-pane='sidebar'], [class*='sidebarCol']) > div {
  background:
...
body[data-dsh-mari-interface] :is([data-pane='sidebar'], [class*='sidebarCol']) > div::before {
  ...
  right: -14px;
  bottom: 82px;
  color: rgba(138, 31, 85, 0.07);
  font: 900 128px/1 Arial, sans-serif;
  letter-spacing: -0.09em;
  pointer-events: none;
}

body[data-dsh-mari-interface][data-ds-dark-theme] :is([data-pane='sidebar'], [class*='sidebarCol']) > div::before {
...
body[data-dsh-mari-interface] button[class*='brand'] > svg {
  color: #8a1f55;
  filter: drop-shadow(0 0 8px rgba(138, 31, 85, 0.16));
}

body[data-dsh-mari-interface][data-ds-dark-theme] button[class*='brand'] > svg {
  color: #ffe0ee;
