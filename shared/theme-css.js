...
body[data-dsh-mari-interface] [data-mari-telemetry] {
  position: absolute;
  right: clamp(14px, 3vw, 52px);
  bottom: 24px;
  padding: 7px 12px 6px;
  border: 1px solid rgba(240, 75, 145, 0.42);
  color: rgba(123, 35, 77, 0.8);
...
body[data-dsh-mari-interface][data-ds-dark-theme] [data-mari-telemetry] {
  color: rgba(255, 180, 211, 0.86);
  background: rgba(29, 8, 24, 0.7);
}

body[data-dsh-mari-interface]:has(:is([data-phase='active'][data-chat-flow], [data-phase='active'] [data-chat-flow])) [data-skin-artwork] {
  opacity: 0.115;
  filter: saturate(0.5) drop-shadow(-10px 12px 22px rgba(39, 8, 28, 0.22));
...
body[data-dsh-mari-interface]:has(:is([data-phase='active'][data-chat-flow], [data-phase='active'] [data-chat-flow])) [data-mari-telemetry] {
  opacity: 0;
}
...
body[data-dsh-mari-interface] [data-skin-chrome='mari-accent-rail']::after {
  content: 'UNIT-08 // OPTICAL TEST RANGE // CALIBRATED';
  position: absolute;
  top: 10px;
  right: 18px;
  padding: 5px 9px 4px;
  border: 1px solid rgba(240, 75, 145, 0.44);
  color: #ffc0dc;
  background: rgba(34, 8, 28, 0.76);
...
@media (max-width: 880px) {
  ...
  body[data-dsh-mari-interface] [data-mari-telemetry],
  body[data-dsh-mari-interface] [data-skin-chrome='mari-accent-rail']::after { display: none; }
